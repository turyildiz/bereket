    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                    <h2 className="text-2xl sm:text-3xl font-bold" style={{ fontFamily: 'var(--font-playfair)', color: 'var(--charcoal)' }}>Team Verwaltung</h2>
                    <p style={{ color: 'var(--warm-gray)', fontFamily: 'var(--font-outfit)' }}>{teamMembers.length} {teamMembers.length === 1 ? 'Teammitglied' : 'Teammitglieder'}</p>
                </div>
            </div>
