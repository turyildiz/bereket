...
export default function NewShopsClient() {
                            ...
                            <div className="flex-1">
                                ...
                                >
                                    ...
                                    <span className="text-sm font-bold">
                                        {totalCount !== null ? `${totalCount} Märkte` : 'Neu Dabei'}
                                    </span>
                                </div>
                                ...
                                >
                                    <span style={{ color: 'var(--mint)' }}>Neu Dabei</span>
                                </h1>
                                <p
                                    className="text-lg sm:text-xl text-white/70 max-w-xl animate-fade-in-up"
                                    style={{ animationDelay: '0.2s' }}
                                >
                                    Alle Märkte in unserer Community, sortiert nach Beitrittsdatum – die Neuesten zuerst.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                {isLoading ? (
                    <div className="flex items-center justify-center py-20">
                        <div className="animate-spin rounded-full h-12 w-12 border-4 border-[var(--cardamom)] border-t-transparent"></div>
                    </div>
                ) : markets.length > 0 ? (
                    <>
                        ...
                        <div ref={loadMoreRef} className="py-8">
                            {isLoadingMore && (
                                <div className="flex items-center justify-center">
                                    <div className="animate-spin rounded-full h-8 w-8 border-4 border-[var(--cardamom)] border-t-transparent"></div>
                                </div>
                            )}
                    ...
                    <div className="text-center py-16">
                        <div className="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center" style={{ background: 'var(--mint)' }}>
                        ...
                        <Link
                            ...
                            style={{ background: 'var(--gradient-fresh)', color: 'white' }}
                        >
                            Zur Startseite
                        </Link>
                    </div>
