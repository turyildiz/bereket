...
export default function AllShopsClient() {
    ...
    const filteredMarkets = useMemo(() => {
        ...
        // Sort: Premium shops first, then by created_at descending
        result.sort((a, b) => {
            // Premium shops first
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`px-4 py-3 rounded-xl font-semibold text-sm transition-all flex items-center gap-2 cursor-pointer whitespace-nowrap ${showPremiumOnly ? 'shadow-lg' : 'hover:shadow-md'
                                    }`}
                                style={{
                            ...
                            <button
                                ...
                                className={`px-4 py-3 rounded-xl font-semibold text-sm transition-all flex items-center gap-2 cursor-pointer whitespace-nowrap ${showNewOnly ? 'shadow-lg' : 'hover:shadow-md'
                                    }`}
                                style={{
